...
const currentVersions={homeCss:12,siteCss:7,zhCss:25,homeJs:16,siteJs:17};
...
function paperAwardsContent() {
  ...
  return paperAwardItems(items.slice(0,4)) + (older.length
    ? '<details class="paper-awards-more"><summary><span class="paper-awards-show-more">查看全部 ' + items.length + ' 项</span><span class="paper-awards-show-less">收起其余 ' + older.length + ' 项</span></summary>' + paperAwardItems(older) + '</details>' : '');
}
